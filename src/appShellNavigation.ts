...
export type AppSection = "home" | "notes" | "files" | "tasks" | "collections" | "bin";
...
export function readAppHistorySection(state: unknown, userId: string): AppSection | null {
  ...
  return entry.section === "home" || entry.section === "notes" || entry.section === "files" || entry.section === "tasks" || entry.section === "collections" || entry.section === "bin" ? entry.section : null;
}
