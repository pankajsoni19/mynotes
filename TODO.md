...
| Wave | Where | Status |
| --- | --- | --- |
| 9 Task Boards | `main` | **All stages on main** (A `cc7faa3`…`d7e94d3`; B `ee65ac6`, `540dbf2`; C `9e9fa2d`, `e10fa19`, `9bb98ff`; D `8a26906`, `cdc173e`, `af44ddc`; 311 tests). Independent review in progress at merge `e7f911e`. |
| 8 MCP scopes | merged `e7f911e` | **Done, reviewed** (`9791188`…`633bffa` + review fixes `65a5b77` publish requires the seen draft revision, `29366d6` no auto-publish of MCP drafts, `1b41d5c` per-user limits across keys; 266 tests). Review: releasable after the fixes. Task tools (`wave8-task-tools` branch) in progress. |
