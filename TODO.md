...
### Wave 13 — Task card UX, board views, dropdowns, Modules — plan of record: `docs/plan/WAVE_13_TASK_CARD_UX.md` (§12 director review). v0.8.0 shipped 13A, 13B, 13C/13D server, 13F, Wave 14. Merged after: 13C UI `1e34a5d`, 13D UI `ba2a03b`, 17C server `ca53482` (905 tests). 13E merged `ed2b663` (945 tests) — Wave 13 complete on main. Test-reliability hardening `96a3ce2`. v0.8.1 released `598fb1e`. Parked for v0.9.0: Wave 15 viewer/guest (branch `worktree-agent-ab767e8572cd0416c`, 968 tests), 17A hierarchy (branch `worktree-agent-a3e1151defaf243ac`, 977 tests). In progress: 17B sprints (on the 17A branch), 17C UI Tasks home/views. D113 payload trim queued for v0.9.0.
