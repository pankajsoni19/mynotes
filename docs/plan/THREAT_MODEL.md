...
Rows T90–T102 of [WAVE_13_TASK_CARD_UX.md](WAVE_13_TASK_CARD_UX.md) §6. Each sub-wave adds its own rows here: 13B (server) covers T92–T94, T96, and T99; 13C (server) covers T101 and extends T99; 13F (Modules) owns T97.
